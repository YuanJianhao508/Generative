...
img_basedir = "/datasets/jianhaoy/waterbird"

intervention_meta_dir = "/datasets/jianhaoy/waterbird/interventionOutput/interventionMetadata"
meta_dir = "/datasets/jianhaoy/waterbird"
...
# Create base model.
if generative_model == 'GLIDE':
    output_dir = "/datasets/jianhaoy/waterbird/interventionOutput/interventionimage"
    ...
    batch_size = 1
    guidance_scale = 5.0
    # A value of 1.0 is sharper, but sometimes results in grainy artifacts.s
    upsample_temp = 0.997


if generative_model == 'VQGAN':
    output_dir = "/datasets/jianhaoy/waterbird/interventionOutput/VQGANimage"
...
background_mapping_dictionary = {'ocean':1,'forest':0,'lake':1,'bamboo forest':0}

for i in tqdm(range(metadata_df.shape[0]),desc='Intervention'):
